<?php /*a:1:{s:34:"../Template/run/menus\created.html";i:1528798690;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <form class="layui-form" action="">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="icon" style="width: 55%;float: left" name="icon" placeholder="请输入Icon图标"
        ...
        <input type="hidden" <?php if((isset($menus))): ?> value="<?php echo htmlentities($menus['id']); ?>" <?php else: ?> value="0" <?php endif; ?> name="pid">
        <input type="hidden" <?php if((isset($menus))): ?> value="<?php echo htmlentities($menus['path']); ?>" <?php else: ?> value="0," <?php endif; ?> name="path">
        <div class="layui-form-item">
    ...
    layui.use(['form', 'jquery'], function () {
        ...
        form.on('submit(subBtn)', function (data) {
            $.ajax({
                type: "post",
                async: true,
                url: "<?php echo url('Menus/created'); ?>",
                data: data.field,
                dataType: "json",
