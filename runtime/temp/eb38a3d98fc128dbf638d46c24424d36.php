<?php /*a:1:{s:36:"../Template/run/functions\index.html";i:1553246280;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="search-block" style="float: right;padding-top: 40px;">
    <form class="layui-form" action="<?php echo url('Functions/index'); ?>" method="post">
...
<table class="layui-table">
    ...
    <tr>
        ...
        <td><img src="<?php echo htmlentities($data['icon']); ?>" alt="图标" style="width: 50px;"></td>
        <td><?php echo htmlentities($data['class_name']); ?></td>
        <td><img src="<?php echo htmlentities($data['code_img']); ?>" alt="二维码" style="width: 50px;"></td>
        ...
        <td>
            <a href="javascript:;" class="layui-btn brandEdit layui-btn-radius" brand_id="<?php echo htmlentities($data['id']); ?>"
               data-name="<?php echo htmlentities($data['name']); ?>" data-function_class_id="<?php echo htmlentities($data['function_class_id']); ?>" data-icon="<?php echo htmlentities($data['icon']); ?>"
               data-code_img="<?php echo htmlentities($data['code_img']); ?>"
               data-content="<?php echo htmlentities($data['intro']); ?>"><i
...
<script>
    ...
    $(".brandEdit").click(function () {
        ...
        $.post('<?php echo url("brandEdit"); ?>', {id: id}, function (e) {
            console.log(e);
            var list = e;
            var len = e.length;
            var str = '';
    ...
    $(".delete").click(function () {
        ...
        layer.confirm('确定要删除？', {btn: ['确定', '取消']}, function () {
            $.post('<?php echo url("brandDel"); ?>', {id: id}, function (data) {
                if (data == 200) {
                    layer.msg("操作成功");
                    location.reload();
                } else {
