<?php /*a:1:{s:33:"../Template/theme/cases\case.html";i:1553237286;}*/ ?>
...
<div class="nbanner">
    <div class="nbanner_1">
        <img src="/static/home/img/casebanner.jpg">
    </div>
</div>
<!-- 分类 -->
<div class="case1">
    <div class="case1_1">
        <ul>
            <li class="case1_1_x">
                <a href="<?php echo url('Cases/index'); ?>">
                    <p><i class="fa fa-th-large" aria-hidden="true"></i></p>
                    <p>全部分类</p>
                </a>
            </li>
            <?php if(is_array($dataClass) || $dataClass instanceof \think\Collection || $dataClass instanceof \think\Paginator): $i = 0; $__LIST__ = $dataClass;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?>
            <li>
                <a href="<?php echo url('Cases/index'); ?>?id=<?php echo htmlentities($data['id']); ?>">
                    <p><i class="fa fa-th-large" aria-hidden="true"></i></p>
        ...
        <div class="case1_1_gd">
            <?php if(is_array($datas) || $datas instanceof \think\Collection || $datas instanceof \think\Paginator): $i = 0; $__LIST__ = $datas;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$da): $mod = ($i % 2 );++$i;?>
            <a href="<?php echo url('Cases/index'); ?>?id=<?php echo htmlentities($da['id']); ?>"><?php echo htmlentities($da['name']); ?></a>
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </div>
    </div>
</div>
...
<div class="nrow nrow_case">
    <ul>
        ...
        <li>
            <div class="ncase2_1">
                <div class="ncase2_1_1">
                    <div class="ncase2_1_1_1"><img src="<?php echo htmlentities($info['icon']); ?>"></div>
                    <div class="ncase2_1_1_2"><span><?php echo htmlentities($info['titles']); ?></span></div>
                    <div class="ncase2_1_1_3"><span><?php echo htmlentities($info['intro']); ?></span></div>
                    <div class="ncase2_1_1_4"><span><?php echo htmlentities($info['name']); ?></span></div>
                </div>
                <div class="ncase2_1_2">
                    <img src="<?php echo htmlentities($info['code_img']); ?>">
                    <div class="ncase2_1_2_1">扫码查看案例</div>
                </div>
            </div>
        </li>
        <?php endforeach; endif; else: echo "" ;endif; ?>
...
<script type="text/javascript">
    $(".case1_1_dj").mouseover(function () {
        $(".case1_1_gd").show()
    });
    $(".case1_1_gd").mouseleave(function () {
        $(".case1_1_gd").hide()
    });
</script>