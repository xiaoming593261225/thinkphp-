<?php /*a:1:{s:40:"../Template/theme/problem\problem_1.html";i:1553221459;}*/ ?>
    ...
    <div class="function_2">
        <div class="function_2_left">
            ...
            <ul>
                ...
                <li>
                    <a href="<?php echo url('Problem/index'); ?>?id=<?php echo htmlentities($info['id']); ?>">
                        <div class="function_2_left_1_x">
                            <i class="fa fa-th-large" aria-hidden="true"></i>
                            <span><?php echo htmlentities($info['name']); ?></span>
                        </div>
                    </a>
                </li>
        ...
        <div class="problem_2_right">
            <div class="problem_2_x">
                <a href="problem.html">问答列表</a>/<span>详情</span>
            </div>
            <div class="problem_2_x1">
                ...
                <div class="problem_2_x1_1"><h4><?php echo htmlentities($data['name']); ?></h4></div>
                <div class="problem_2_x1_2">
                    <p style="font-size: 14px;line-height: 25px;">
                        <?php echo !empty($data['content']) ? htmlentities($data['content']) : "暂无"; ?>
                    </p>
                </div>
                <?php endforeach; endif; else: echo "" ;endif; ?>
                <div class="problem_2_x1_3">
                    <a class="problem_2_x1_3_1">
                        <i class="fa fa-thumbs-o-up" aria-hidden="true"></i><span>问题已解决，点个赞</span>
                    </a>
                    <a href="#" class="problem_2_x1_3_2">
                        <i class="fa fa-thumbs-o-down" aria-hidden="true"></i><span>问题未解决，我要提问</span>
                    </a>
                </div>
            </div>
        </div>
