<?php /*a:1:{s:31:"../Template/run/type\lists.html";i:1528798689;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="layui-tab-content" style="background-color: rgba(255,255,255,1);margin-top: 5px;">
    <div class="layui-tab-item layui-show">
        <div class="layui-btn-group demoTable" style="float: left;">
            <button class="layui-btn layui-btn-sm" id="created">添加分类</button>
...
<script type="text/html" id="tool">
    ...
    <a class="layui-btn layui-btn-xs layui-btn-primary layui-btn-radius" lay-event="create-children">添加子分类</a>
...
<script type="text/html" id="ismenu-tpl">
    <input type="checkbox" name="delete" data-id="{{ d.id }}" value="{{d.delete}}" lay-skin="switch" lay-text="正常|删除" lay-filter="is_menu" {{ d.delete == 1 ? 'checked' : '' }}>
</script>
...
<script type="text/javascript">
    ...
    layui.config({
        ...
        table.render({
            elem: '#table_list'
            , url: "<?php echo url('Type/lists'); ?>"
            , cols: [[
                {checkbox: true, fixed: true}
                , {field: 'id', title: 'ID', width: "5%"}
                , {field: 'icon', title: '图标', width: "15%", edit: "text", templet: '#icon'}
                , {field: 'name', title: '分类名称', width: "25%"}
                , {field: 'path', title: '菜单等级', width: "25%"}
                , {field: 'delete', title: '分类状态', width: "15%", templet: '#ismenu-tpl'}
        ...
        $("#created").click(function () {
            layer.open({
                ...
                type: 2,
                area: ['400px', '400px'],
                content: "<?php echo url('Type/created'); ?>"
            });
        });
        //全选删除
