<?php /*a:1:{s:38:"../Template/theme/problem\problem.html";i:1553248053;}*/ ?>
    ...
    <div class="function_2">
        <div class="function_2_left">
            <div class="function_2_left_1">
                <div class="function_2_left_1_x"><i class="fa fa-th-large" aria-hidden="true"></i><span>
                    <a href="<?php echo url('Problem/index'); ?>" style="color: #0C0C0C">问题分类</a>
                </span>
                </div>
            </div>
            <ul>
                ...
                <li>
                    <a href="<?php echo url('Problem/index'); ?>?id=<?php echo htmlentities($data['id']); ?>">
            ...
            <div class="problem_1">
                <a href="<?php echo url('Problem/problem_2'); ?>">我要提问</a>
            </div>
        </div>
        <div class="problem_2_right">
            <div class="problem_2_0">
                <form action="<?php echo url('Problem/index'); ?>">
                    <div class="problem_2_0_1"><input type="text" placeholder="请输入关键词" name="keyWords" id="keyWords">
                    </div>
                    <div class="problem_2_0_2"><a href="#"><i class="fa fa-search" aria-hidden="true"></i></a></div>
                </form>
            </div>
            <div class="problem_2">
                <ul>
                    ...
                    <li><a href="<?php echo url('Problem/problem_1'); ?>?id=<?php echo htmlentities($info['id']); ?>"><?php echo htmlentities($info['name']); ?></a></li>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
            </div>
            <div class="nrow_3">
            ...
            <div class="foot-top">
                ...
                <div class="foot-link">
                    ...
                    <div class="link-detail">
                        <p>联系我们</p>
                        <ul>
                            <li><a href="#" class="foot-button fb-1"> <img src=".//static/home/img/foot_qq.png" alt=""> 在线咨询</a>
                            </li>
                            <li><a href="#" class="foot-button fb-2"> <img src=".//static/home/img/foot_sina.png" alt="">
                                新浪微博</a></li>
...
<script>
    ...
    //     $.post('<?php echo url("index"); ?>', {name: keyWords}, function () {
    //
    //     });
    // });
</script>
