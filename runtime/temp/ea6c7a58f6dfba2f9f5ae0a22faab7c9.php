<?php /*a:1:{s:41:"../Template/theme/functions\function.html";i:1553239897;}*/ ?>
...
<div class="nbanner">
    <div class="nbanner_1">
        <img src="/static/home/img/functionbanner.jpg">
    </div>
</div>
<div class="nnews_1_1">
    <div class="nrow_1">
        <div class="nrow_1_1"><span>功能类型</span>/<i>TYPE</i></div>
        <div class="nrow_1_2">
            <form action="<?php echo url('Functions/index'); ?>" method="get">
                <div class="function_ss">
                    <input type="text" placeholder="搜索功能" name="brand" id="brand">
    ...
    <div class="function_2">
        <div class="function_2_left">
            <div class="function_2_left_1">
                <div class="function_2_left_1_x"><i class="fa fa-th-large" aria-hidden="true"></i><span><a
                        href="<?php echo url('Functions/index'); ?>" style="color: #0C0C0C">全部分类</a></span>
                </div>
            </div>
            <ul>
                ...
                <li>
                    <a href="<?php echo url('Functions/index'); ?>?id=<?php echo htmlentities($data['id']); ?>">
        ...
        <div class="function_2_right">
            <ul>
                ...
                <li>
                    <div class="fr1">
                        <div class="fr1_1">
                            <h4><?php echo htmlentities($info['name']); ?></h4>
                            <span><?php echo htmlentities($info['intro']); ?></span>
                        </div>
                        <div class="fr1_2"><img src="<?php echo htmlentities($info['icon']); ?>" width="50px"></div>
                        <div class="fr1_3">
                            <div class="fr1_3_1">
                                <div class="fr1_3_1_1">
                                    <span>用一系列场景图片展示产品和服务   <p>【查看功能演示】 </p><p>扫描右侧二维码 >></p><p>回复关键词：</p><p
                                            style="color: #ff000c;">微画报（微场景）</p></span>
                                </div>
                                <div class="fr1_3_1_2"><img src="<?php echo htmlentities($info['code_img']); ?>"></div>
                            </div>
                        </div>
                    </div>
                </li>
